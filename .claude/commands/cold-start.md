...
2. `ggr-docs/MEMORY.md` oku — kalici hafiza, teknik kararlar, ogrenilen pattern'ler
3. `ggr-tasks/task-index.md` oku — dashboard + tum task durumlari
4. `ggr-tasks/active/session-notes.md` oku — onceki session notlari
