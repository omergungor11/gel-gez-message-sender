...
3. `ggr-tasks/task-index.md` oku — aktif/tamamlanmis task durumunu kontrol et
4. Eger IN_PROGRESS task varsa ve isi bittiyse:
   ...
   - ggr-docs/CHANGELOG.md'ye kisa bir kayit ekle
5. .env dosyalarinin stage'lenmediginden emin ol
6. Tum ilgili dosyalari stage et (.env, credentials, service-account.json haric)
